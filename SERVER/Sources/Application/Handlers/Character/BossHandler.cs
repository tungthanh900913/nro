            ...
            switch(Boss.Type)
            {
                ...
                case 3://super black goku
                {
                    ...
                    if (randomPercent < 25)
                    {
                        ...
                        var listGiayThan = new List<short>(){555,556,557,558,559,560,561,562,563,564,565,566,567,457,457,992};
                        randomPercent = ServerUtils.RandomNumber(50); 
                        if (randomPercent <= 5) //tile them sao duc lo
                        {
                            item = ItemCache.GetItemDefault(listGiayThan[ServerUtils.RandomNumber(listGiayThan.Count)]);
                            var soSaoGiayThan = ServerUtils.RandomNumber(1, 3);
						...
						else if (randomPercent <= 18) {
							//var item = ItemCache.GetItemDefault(190);
							var listhuydiet = new List<short>(){650,651,652,653,654,655,656,657,658,659,660,661,662};
							randomPercent = ServerUtils.RandomNumber(50); 
							if (randomPercent <= 5) //tile them sao duc lo
							{
								item = ItemCache.GetItemDefault(listhuydiet[ServerUtils.RandomNumber(listhuydiet.Count)]);
								var soSaoGiayThan = ServerUtils.RandomNumber(1, 3);
								item.Options.Add(new OptionItem()
								{
									Id = 107,
                ...
                case 11://Cooler 02
                {
                    ...
                    if (randomPercent < 10)
                    {
						...
						var listItem = new List<short>(){708,707,706,705,457};
						...
						if (randomPercent < 10) {
							//var item = ItemCache.GetItemDefault(190);
							var listGiayThan = new List<short>(){650,651,652,653,654,655,656,657,658,659,660,661,662};
							randomPercent = ServerUtils.RandomNumber(50); 
							if (randomPercent <= 10) //tile them sao duc lo
							{
								item = ItemCache.GetItemDefault(listGiayThan[ServerUtils.RandomNumber(listGiayThan.Count)]);
								var soSaoGiayThan = ServerUtils.RandomNumber(1, 3);
								item.Options.Add(new OptionItem()
				...
				case 57://NgoKhong
                {
                    var listItem = new List<short>(){708,707,706,705,704,703,702};
                    for (int i = 0; i < ServerUtils.RandomNumber(1, 2); i++)
                    {
                        var item = ItemCache.GetItemDefault(listItem[ServerUtils.RandomNumber(listItem.Count)]);
                        item.Quantity = ServerUtils.RandomNumber(1, 5);
                        var itemMap = new ItemMap(-1, item);
