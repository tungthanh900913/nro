...
namespace NRO_Server.Main.Menu
{
    public class MenuNpc
    {
		...
		public List<string> TextPanchy= new List<string>()
        {
            "Muốn uống nước đái không cưng?",
            $"{ServerUtils.Color("red")}Bảng đổi điểm sự kiện xem tại thông báo của NRO FOR \b"+
             $"{ServerUtils.Color("blue")}2500 điểm : MỘT hộp quà 8/3 (mở ra những vật phẩm xịn xò con bò)\b" ,
        };
		public List<List<string>> MenuPanchy = new List<List<string>>()
        {
            new List<string>()
            {
                "CÓ", 
        ...
        public List<string> TextSanta = new List<string>()
        {
            ...
            "|0|Con đang có: {0} VND\nTổng Nạp: {1} VND",
            "|7|Con đang có: {0} VND",
            "|7|Con đang có: {0} VND\n|6|Muốn kích hoạt thành viên cần 10.000 VND",
            "|7|Con đang có: {0} VND\n|6|Con muốn đổi vàng hay Đá Ngũ Sắc ?",
            "|7|Con đang có: {0} VND\n|6|Con muốn đổi đệ tử xịn hay không?\n|0|Tùy chọn 1) Đệ VIP [300k] : HỢP THỂ TĂNG 40%\n|0|Tùy chọn 2) Đá hắc hoả + vĩnh hằng [15k] ",
        };
        ...
        public List<List<string>> MenuSanta = new List<List<string>>()
        {
            ...
            new List<string>()
            {
                "Đổi vàng\nĐá Ngũ Sắc", "Kích hoạt\nThành viên","Đại Gia", "Từ chối"
            },
            new List<string>()
            {
                "Đổi vàng","Đổi Đá Ngũ Sắc",
            },
            new List<string>()
            {
                "10K\n30 Thỏi","20K\n60 Thỏi", "50K\n150 Thỏi", "100k\n300 Thỏi", "200k\n600 Thỏi", "500k\n1500 Thỏi"
