                ...
                switch (command)
                {
                    ...
                    case 44:
                    {
                        ...
                        if (!text.Equals("") && character != null && role == 1)
                        {
								...
								else if (text.Contains("bnk"))
                                {
                                    var charReal = (Character)character;
                                    var boss = new Boss();
                                    boss.CreateBoss(DataCache.BOSS_NgoKhong_TYPE, charReal.InfoChar.X, charReal.InfoChar.Y);
                                    boss.CharacterHandler.SetUpInfo();
                                    character.Zone.ZoneHandler.AddBoss(boss);
                                }
                                #endregion
