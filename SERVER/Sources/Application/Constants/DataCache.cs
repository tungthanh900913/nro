...
namespace NRO_Server.Application.Constants
{
    public class DataCache
    {
        ...
        public static List<short> LIMIT_SO_LAN_GOI_RONG = new List<short> { 100, 100 };//tài khoản thường, tài khoản premium

        public static readonly int LIMIT_NOT_PREMIUM_TRADE_DAY = 50000;//ngày giao dịch 5 lần
        ...
        // Giá mở nội tại
        public static readonly int PRICE_UNLOCK_SPECIAL_SKILL = 2000; //ngọc
        ...
        public static List<int> ItemPremiumTrade = new List<int> { 457, 934, 886, 887, 888, 889, 987, 1087, 1036 };
        ...
        #region Combinne
        public static readonly long MAX_LIMIT_UPGRADE = 12;
        ...
        public static int[][] PercentPhaLe = new int[][]{
            //vàng * 1tr, 50%, 10 ngọc
            new int[] {5, 100, 10}, // 1sao
            new int[] {10, 80, 20}, //2 sao
            new int[] {20, 80, 30}, //3 sao
            new int[] {40, 80, 40}, //4 sao
            new int[] {60, 80, 50}, //5 sao
            new int[] {80, 80, 60}, //6 sao
            new int[] {110, 80, 70}, //7 sao
            new int[] {140, 80, 140}, //8 sao
			new int[] {210, 80, 200}, //9 sao
            new int[] {250, 80, 240}, //10 sao
			new int[] {300, 80, 280}, //11 sao
			new int[] {350, 80, 320}, //12 sao
       };

        public static List<List<int>> PercentUpgrade = new List<List<int>>{
            //số đá, vàng, %
            new List<int>(){2, 10, 100},
            new List<int>(){3, 20, 80},
            new List<int>(){4, 30, 40},
            new List<int>(){5, 40, 30},
            new List<int>(){6, 50, 20},
            new List<int>(){7, 60, 15},
            new List<int>(){8, 70, 10},
            new List<int>(){9, 80, 5},
        };
		...
		public static readonly int BOSS_NgoKhong_TYPE = 57;
        ...
        #region Lucky Box
        public static List<short> LuckBoxRare = new List<short>() { 883, 883, 883, 904, 904};
