...
namespace NRO_Server.Application.Constants
{
    public class TextServer
    {
        ...
        public readonly string NAP_VANG = "Hãy truy cập web NRO HYDRA để xem hướng dẫn nạp thêm VNĐ rồi quay lại đây nhé.";
        ...
        public readonly string UPGRADE_TO_PREMIUM = "Xin chúc mừng bạn đã là thành viên chính thức của NRO HYDRA";
		...
		public readonly string GET_DA = "Bạn đã nhận được {0} Đá ngũ sắc";
